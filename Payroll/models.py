...
class RateCardSalaryElement(models.Model):
    ...
    item_name = models.TextField(null=True, blank=True)
    pay_type = models.ForeignKey('Payroll.pay_type', on_delete=models.CASCADE,related_name='rate_card_pay_type',blank=True, null=True,db_column='pay_type')
    classification = models.ForeignKey('Payroll.basis_type', on_delete=models.CASCADE,related_name='rate_card_clasification',blank=True, null=True,db_column='classification')
