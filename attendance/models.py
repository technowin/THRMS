...
class DailyAttendance(models.Model):
    ...
    pl = models.BooleanField(null=True, blank=True)
    sl = models.BooleanField(null=True, blank=True)
    cl = models.BooleanField(null=True, blank=True)
    other_leave = models.IntegerField(null=True, blank=True)
    in_time = models.TimeField(null=True, blank=True)
    out_time = models.TimeField(null=True, blank=True)
    site_id = models.ForeignKey(site_master, on_delete=models.CASCADE,related_name='site_att_id',null=True,db_column='site_id')
    company_id = models.ForeignKey(company_master, on_delete=models.CASCADE,related_name='comapny_att_id',null=True,db_column='company_id')
    latitude = models.CharField(max_length=255,null=True, blank=True)
    longitude = models.CharField(max_length=255,null=True, blank=True)
...
class ShiftMaster(models.Model):
    ...
    in_shift_time = models.TimeField(null=True)
    out_shift_time = models.TimeField(null=True)
